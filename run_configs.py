class ConfigClass:
    def __init__(self, stemming=True, ext_url=True, emoji=True, quotes=True, entity=True,
                 less_more=True, number=True, hashtag=True, url=True, tag=True, capitals=True, spellcheck=False,
